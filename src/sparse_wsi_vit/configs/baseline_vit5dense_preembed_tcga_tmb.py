"""ViT-5 classification config for training a dense, mini ViT5 model on TCGA
...
# ─── Data Details ──────────────────────────────────────────────
CSV_TRAIN_FOLD = "../splits/tcga-tmb/full"
TARGET_NAME = "tmb_binary"
TARGET_OPTIONS = ("TMB-L", "TMB-H")
